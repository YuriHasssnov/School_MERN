...
import SchoolDataPage from "./pages/School";
import DataEditPage from "./pages/EditData";
        ...
        <main>
          ...
          <div>
            <Switch>
              ...
              <Route path={`${process.env.PUBLIC_URL}/save`} component={SavePage}/>
              <Route path={`${process.env.PUBLIC_URL}/add`} component={AddPage}/>
              <Route path={`${process.env.PUBLIC_URL}/send`} component={SendPage}/>
              <Route path={`${process.env.PUBLIC_URL}/users`} component={UsersPage}/>
              <Route path={`${process.env.PUBLIC_URL}/data`} component={DataPage}/>
              <Route path={`${process.env.PUBLIC_URL}/edit/:id`} component={UserEditPage}/>
              <Route path={`${process.env.PUBLIC_URL}/school/:id`} component={SchoolDataPage}/>
              <Route path={`${process.env.PUBLIC_URL}/editData/:id`} component={DataEditPage}/>
